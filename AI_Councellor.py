...
class DynamicCollegeCounselorChatbot:
    ...
    Uses OpenAI to intelligently extract and categorize any relevant information from conversations.
    """
    ...
    def dynamic_information_extraction(self, user_message):
        """
        Use OpenAI to dynamically extract any relevant information from user messages.
    ...
    def assess_information_sufficiency(self):
        ...
        Uses OpenAI to make intelligent decisions about readiness.
        """
